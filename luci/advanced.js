...
return view.extend({
	...
	render: function (data) {
		...
		o = s.option(form.Value, 'probe_interval',
			...
			_('Только для режима автовыбора: с каким шагом Xray проверяет задержку до каждого ключа. Чаще — быстрее заметит отвал, но больше лишнего трафика.'));
		o.placeholder = '3m';
		...
		o = s.option(form.Value, 'xray_bin', _('Движок Xray'),
